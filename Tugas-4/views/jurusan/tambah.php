...
<body>
    ...
    <div class="container">
        <main>
            <div class="post">
                <h2>Menambah Data Jurusan</h2>
                <?php
                if (isset($_POST['submit'])) {
                    $tambah = $jurusan->tambahJurusan($_POST);
                    if ($tambah) {
                        echo "<script>alert('Berhasil menambahkan data jurusan');";
                ...
                <form method="POST" action="">
                    <div class="form-group row">
                        ...
                        <input type="text" name="jurusan" class="form-control col-md-8" id="jurusan" />
                    </div>
                    <div class="form-group row">
                        <label for="deskripsi" class="col-md-2 col-form-label">Deskripsi</label>
                        <textarea id="deskripsi" class="form-control col-md-8" name="deskripsi"></textarea>
                    </div>
