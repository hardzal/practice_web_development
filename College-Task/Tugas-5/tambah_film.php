...
<body>
    <div class='container'>
        ...
        <section>
            ...
            <?php if(isset($_POST['submit'])) insertFilm();?>
            <form action="" method="POST" enctype="multipart/form-data">
                <table class="">
                    ...
                    <tr>
                        <td>Sutradara</td>
                        <td>:</td>
                        <td><input type='text' name='sutradara' maxlength='50' required /></td>
                    </tr>
                    <tr>
                        <td>Pemain Utama</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Tahun</td>
                        <td>:</td>
                        <td><input type='text' name='tahun' required minlength="4" maxlength="4"></td>
                    </tr>
                    <tr>
                        <td>Sinopsis</td>
                        <td>:</td>
